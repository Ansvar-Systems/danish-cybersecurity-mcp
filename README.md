...
**Endpoint:** `https://mcp.ansvar.eu/danish-cybersecurity/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add danish-cybersecurity-mcp --transport http https://mcp.ansvar.eu/danish-cybersecurity/mcp` |
...
```json
{
  "mcpServers": {
    "danish-cybersecurity-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/danish-cybersecurity/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/danish-cybersecurity-mcp
```
...
```json
{
  "mcpServers": {
    "danish-cybersecurity-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/danish-cybersecurity-mcp"]
    }
  }
}
```
